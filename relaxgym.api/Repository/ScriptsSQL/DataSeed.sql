...
INSERT INTO relaxgym_db.clases VALUES(3,'3e96811c575c4f179e64d151080bdce7', 'Zumba', 'Zumba es un movimiento o disciplina fitness de origen colombiano, enfocado por una parte a mantener un cuerpo saludable y por otra a desarrollar, fortalecer y dar flexibilidad al cuerpo mediante movimientos de baile combinados con una serie de rutinas aeróbicas..');
INSERT INTO relaxgym_db.clases VALUES(4,'477ad6993326483a9dd2fc1060c984a8', 'AeroBox', 'El aerobox es una opción diferente para ejercitarse de manera divertida y no sólo quemar calorías, sino que la combinación de boxeo con el aerobic, permite tonificar al mismo tiempo que se reciben los beneficios cardiovasculares, qué este último aporta..');
INSERT INTO relaxgym_db.clases VALUES(5,'4f6f84c08cc74128aebcd9f655eda182', 'Spinning', 'El spinning consiste en la realización de ejercicios sobre la bicicleta, compaginándolos con la música y efectuando coreografías, fundamentalmente buscando la diversión del público asistente, al mismo tiempo que trabaja a nivel global la tonificación del tronco y las extremidades superiores..');
INSERT INTO relaxgym_db.clases VALUES(6,'7704e6812836465a84afe645c45b2267', 'Pilates', 'El Método Pilates es un conjunto de movimientos controlados para el cuerpo y la mente. Dichos movimientos y ejercicios también se realizan sobre colchonetas y máquinas de pilates diseñadas especialmente para una correcta ejecución..');
INSERT INTO relaxgym_db.clases VALUES(7,'fb9b17b32c9846e29dc9b17e7f61a59c', 'BodyPump', 'Las clases de BodyPump tienen una duración de 60 minutos y contienen ocho canciones o "tracks", cada una de las cuales se centra en un grupo muscular diferente, además de un track para el calentamiento al inicio de la clase y otro al final para relajación y estiramientos...');
INSERT INTO relaxgym_db.clases VALUES(8,'4723c0b3c8334dad96bca1235f3fae2b', 'Yoga', 'Generalmente todas las sesiones de Yoga incluyen un tiempo de relajación y meditación que puede venirte genial si lo que buscas es conectar contigo mismo y escapar del estrés diario. Una disciplina a tener muy en cuenta para cuidar nuestro cuerpo y nuestra mente....');
INSERT INTO relaxgym_db.clases VALUES(9,'7355148bb23b4dadb4dfe54f89385906', 'Abdominales', 'Clase de 45 minutos donde se realizan distintos tipos de abdominales....');
INSERT INTO relaxgym_db.clases VALUES(10,'01adb6cc7d244190bde9c94fa306161d', 'Circuit Training', 'Este tipo de clases están orientadas al trabajo por estaciones. Son clases muy dinámicas que permiten realizar diversos ejercicios con materiales o ejecuciones distintas. Se preparan las estaciones, cada una con un trabajo específico, y la clase se organiza en grupos, los cuales irán pasando de estación a estación durante la misma...');
